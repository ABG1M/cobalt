...
import { env, version } from "./src/modules/config.js";

import { generateHmac, generateSalt } from "./src/modules/sub/crypto.js";
import { Bright, Cyan } from "./src/modules/sub/consoleText.js";
import { languageCode } from "./src/modules/sub/utils.js";
import loc from "./src/localization/manager.js";

import { createResponse, normalizeRequest, getIP } from "./src/modules/processing/request.js";
import { verifyStream, getInternalStream } from "./src/modules/stream/manage.js";
import { randomizeCiphers } from './src/modules/sub/randomize-ciphers.js';
import { extract } from "./src/modules/processing/url.js";
import match from "./src/modules/processing/match.js";
import stream from "./src/modules/stream/stream.js";
...
runAPI(express, app, "NONE", "origin", __dirname);
export default app;
